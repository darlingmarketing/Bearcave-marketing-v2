...
const CMO_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    year: "2024",
    tags: ["Non-Profit", "Event Marketing", "Sponsorship"],
    roi: "$46k+",
    roiLabel: "Revenue Generated",
    techStack: ["Event Strategy", "Sponsorship Tiers", "Digital Platform"],
    techHighlight: "$46k+",
    techHighlightLabel: "Revenue Generated",
  },
  {
    id: "urgent-care-indy",
    ...
    year: "2024",
    tags: ["Healthcare", "Digital Integration", "Patient Growth"],
    roi: "+35%",
    roiLabel: "Booking Increase",
    techStack: ["Clockwise MD", "AnywhereCare", "HIPAA Pipeline"],
    techHighlight: "2 APIs",
    techHighlightLabel: "Healthcare Integrations",
  },
  {
    id: "clean-aesthetic",
    ...
    year: "2024",
    tags: ["Brand Identity", "Medical Aesthetics", "Luxury"],
    roi: "4 Wks",
    roiLabel: "Brand Launch",
    techStack: ["Brand Identity", "Monogram Design", "Digital Rollout"],
    techHighlight: "4 Wks",
    techHighlightLabel: "Brand Launch",
  },
  {
    id: "russell-painting",
    ...
    year: "2024",
    tags: ["Local SEO", "Lead Generation", "Heritage Brand"],
    roi: "4.9★",
    roiLabel: "Star Sentiment",
    techStack: ["Local SEO", "Trust Architecture", "Review Optimisation"],
    techHighlight: "4.9★",
    techHighlightLabel: "Star Sentiment",
  },
  {
    ...
    year: "2024",
    tags: ["E-Commerce", "DTC Strategy", "Amazon"],
    roi: "4+★",
    roiLabel: "Amazon Rating",
    techStack: ["Shopify DTC", "Amazon Marketplace", "Content Strategy"],
...
const CTO_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    client: "Indianapolis Urgent Care Clinic",
    year: "2024",
    tags: ["Healthcare", "API Integration", "HIPAA"],
    roi: "+35%",
    roiLabel: "Booking Increase",
    techStack: ["Clockwise MD", "AnywhereCare", "HIPAA Pipeline"],
    techHighlight: "2 APIs",
  ...
  },
  {
    ...
    client: "Behr Pet Essentials",
    year: "2024",
    tags: ["E-Commerce", "Multi-Channel", "Shopify"],
    roi: "4+★",
    roiLabel: "Amazon Rating",
    techStack: ["Shopify DTC", "Amazon Marketplace", "Content Strategy"],
    techHighlight: "2 Channels",
