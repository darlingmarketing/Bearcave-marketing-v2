...
export const projects: Project[] = [
  ...
  },
  {
    ...
    subtitle: "Intelligent Self-Service Support System",
    hook: "CRM-Aware Assistant: Instant Support via Cloudflare Workers.",
    metrics: [
      { label: "Self-Service", value: "Automatic" },
      { label: "Integration", value: "3 Systems" },
      { label: "Support Load", value: "−40%" },
    ],
    tags: ["AI/ML", "Cloudflare Workers", "CRM", "Automation"],
    narrative: {
      act1: "Support teams were buried under repetitive inquiries regarding order status and course prerequisites, creating a bottleneck that slowed response times for complex issues.",
      act2: "Architected a CRM-aware AI assistant using Cloudflare Workers. I integrated WooCommerce, LearnDash, and FluentCRM to allow the bot to verify orders and training history in real-time.",
      act3: "Transformed support operations by automating the majority of common inquiries, resulting in faster user resolution and higher-quality hand-offs for human agents.",
    },
  },
  {
    id: "events-hub",
    ...
    subtitle: "Unified Administrative Command Center",
    hook: "One Pane of Glass for Enrollment Health & Ops.",
    metrics: [
      { label: "Manual Tasks", value: "0" },
      { label: "Insight Speed", value: "Real-time" },
      { label: "Rescue Rate", value: "Increased" },
    ],
    tags: ["Dashboard", "Data Aggregation", "LMS", "REST API"],
    narrative: {
      act1: "Instructors were operating in the dark with fragmented data scattered across spreadsheets, making it impossible to identify at-risk courses or attendee equipment needs.",
      act2: "Built a unified hub that aggregates LearnDash progress, WooCommerce SKUs, and CRM tags into a single REST-powered dashboard with role-scoped access control.",
      act3: "Streamlined operations by flagging 'Danger Zone' events for rescue marketing, reducing the time-to-insight from hours of manual work to a single click.",
    },
  },
  {
    id: "provider-analytics",
    lens: ["cto", "cmo"],
    title: "Provider ROI Dashboard",
    subtitle: "GA4-Powered Member Retention Layer",
    hook: "Proving ROI: Syncing GA4 Metrics into Member Profiles.",
    metrics: [
      { label: "Attribution", value: "GA4 API" },
      { label: "Retention", value: "+22%" },
      { label: "Self-Serve", value: "100%" },
    ],
    tags: ["Analytics", "GA4 API", "Retention", "Data Viz"],
    narrative: {
      act1: "Members had no visibility into their profile performance, leading to churn risks as they couldn't quantify the value of their directory listing.",
      act2: "Developed an analytics layer that syncs GA4 metrics directly into WordPress post meta, visualizing views, link clicks, and source breakdowns for every provider.",
      act3: "Gave providers undeniable proof of ROI, significantly lowering support tickets related to 'profile effectiveness' and increasing membership renewal rates.",
    },
  },
  {
    id: "gtm-data-revamp",
    lens: ["cto"],
    title: "GTM & GA4 Architecture Revamp",
    subtitle: "Data Integrity & Attribution Foundation",
    hook: "Building a Foundation of Truth for Marketing Decisions.",
    metrics: [
      { label: "Data Accuracy", value: "100%" },
      { label: "ROAS Lift", value: "Significant" },
      { label: "Latency", value: "Reduced" },
    ],
    tags: ["GTM", "Server-Side Tagging", "PHP Hooks", "Attribution"],
    narrative: {
      act1: "Marketing decisions were based on a 'crumbling foundation' of legacy tags and inconsistent event tracking, leading to unreliable attribution and wasted ad spend.",
      act2: "Implemented a normalized event schema using server-side PHP hooks to push clean data into GTM and GA4. Reconfigured ad platforms to ignore false-positive signals.",
      act3: "Delivered a high-integrity data layer that allows leadership to make profitable, data-driven decisions with total confidence in their attribution models.",
    },
  },
  {
    ...
    subtitle: "End-to-End LMS Pipeline",
    hook: "Zero Friction: From Purchase to Certification.",
    metrics: [
      { label: "Admin Time", value: "−95%" },
      { label: "Delays", value: "Near-Zero" },
      { label: "Ticket Vol", value: "Reduced" },
    ],
    tags: ["Automation", "Workflow", "WooCommerce", "LMS"],
    narrative: {
      act1: "The student journey was fragmented; purchase-to-enrollment handoffs required manual intervention, leading to certificate delays and administrative overhead.",
      act2: "Architected a fully automated pipeline using WP Fusion and Uncanny Automator to instantly trigger enrollments and evaluation logging upon checkout.",
      act3: "Achieved a seamless, professional experience for students that eliminated certificate delivery delays and freed the team from manual data entry.",
    },
  },
  {
    id: "edge-image-pipeline",
    lens: ["cto"],
    title: "Edge Image Optimization",
    subtitle: "LCP Performance Infrastructure",
    hook: "Instant LCP Wins: Device-Aware Optimization at the Edge.",
    metrics: [
      { label: "LCP Speed", value: "−500ms" },
      { label: "Cache Hit", value: "90%+" },
      { label: "Payload", value: "−60%" },
    ],
    tags: ["Edge Computing", "Performance", "Cloudflare", "Next-Gen Formats"],
    narrative: {
      act1: "Media-heavy pages were crushing Largest Contentful Paint (LCP) scores. Traditional plugin-based optimization couldn't handle device-aware caching effectively.",
      act2: "Built a Cloudflare Edge Worker to negotiate AVIF/WebP formats and resize assets on-the-fly based on Device Pixel Ratio (DPR) and locale headers.",
      act3: "Improved LCP by up to 500ms across media-heavy routes while drastically reducing bandwidth costs through higher cache hit ratios.",
    },
  },
  {
    id: "wp-cicd-pipeline",
    lens: ["cto"],
    title: "CI/CD Deployment Engine",
    subtitle: "Automated Deployment & Testing Infrastructure",
    hook: "Versioned Stability: GitHub Actions + Automated Rollback.",
    metrics: [
      { label: "Deploy Risk", value: "Near-Zero" },
      { label: "Recovery Time", value: "Minutes" },
      { label: "Build Speed", value: "Fast" },
    ],
    tags: ["CI/CD", "DevOps", "GitHub Actions", "WP-CLI"],
    narrative: {
      act1: "Manual FTP deployments were creating risk and inconsistency. Bad deploys often took an hour to recover, threatening business continuity during peak traffic.",
      act2: "Engineered a GitHub Actions pipeline that artifacts releases, runs automated smoke tests, and deploys via rsync with WP-CLI cache flushing.",
      act3: "Eliminated deployment anxiety with instant rollback capabilities, allowing the team to ship small changes frequently and safely.",
    },
  },
];
